        ...
        <div className="flex flex-row justify-center align-center">
            ...
            <form className="relative top-[10px] ml-[30px] bg-white shadow-md rounded px-2 pt-2 pb-8 mb-4 text-[15px] w-[970px] flex flex-col justify-center items-center"
                ...
                <div>
                    ...
                    <input value={data["name"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <textarea value={data["description"]} className=" mt-[12px]  resize shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input value={data["engine"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["seats"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input value={data["length"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input value={data["price"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input value={data["interior"][0]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["interior"][1]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["interior"][2]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["exterior"][0]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["exterior"][1]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["exterior"][2]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div>
                    ...
                    <input  value={data["carImage"]} className=" mt-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <button className="bg-stone-900 mt-[30px] hover:bg-stone-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline" type="submit">Edit car</button>
            </form>
        </div>
