        ...
        <div className="flex flex-row justify-center align-center">
            ...
            <form
                ...
                <div>
                    ...
                    <textarea className="input-form" id="description" name="description" placeholder="Description"
                              required onChange={(e) => setCar({...car, description: e.target.value})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="carType">CarType</label>
                    <select className="input-form" id="carType" name="carType" placeholder="CarType" required
                ...
                <div>
                    ...
                    <select className="input-form" id="engineType" name="engineType" placeholder="EngineType" required
                            onChange={(e) => setCar({...car, engineType: e.target.value})}>
                ...
                <div>
                    ...
                    {data
                    &&
                    <select className="input-form" id="brand" name="brand" placeholder="Brand" required
                ...
                <div>
                    ...
                    <input className="input-form" type="text" id="interiour1" name="interior1" placeholder="interior1"
                           required onChange={(e) => setCar({...car, interior: [...car.interior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="interior2">Interior picture 2</label>
                    <input className="input-form" type="text" id="interior2" name="interior2" placeholder="interior2"
                           required onChange={(e) => setCar({...car, interior: [...car.interior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="interior3">Interior picture 3</label>
                    <input className="input-form" type="text" id="interiour3" name="interior3" placeholder="interior3"
                           required onChange={(e) => setCar({...car, interior: [...car.interior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="exterior1">Exterior picture 1</label>
                    <input className="input-form" type="text" id="exterior1" name="exterior1" placeholder="interior1"
                           required onChange={(e) => setCar({...car, exterior: [...car.exterior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="exterior2">Exterior picture 2</label>
                    <input className="input-form" type="text" id="exterior2" name="exterior2" placeholder="exterior2"
                           required onChange={(e) => setCar({...car, exterior: [...car.exterior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="exterior3">Exterior picture 3</label>
                    <input className="input-form" type="text" id="exterior3" name="exterior3" placeholder="exterior3"
                           required onChange={(e) => setCar({...car, exterior: [...car.exterior, e.target.value]})}/>
                </div>
                <div>
                    <label className="block mt-[12px]" htmlFor="backgroundImage">Background image</label>
                    <input className="input-form" type="text" id="backgroundImage" name="backgroundImage"
                           placeholder="backgroundImage" required
