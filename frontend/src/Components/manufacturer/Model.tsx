...
const Model = () => {
    ...
    return (
        ...
        <div>
            ...
            <p className="relative text-[20px] w-[1000px] m-auto mb-[100px]">The new design of the Audi S5 Coupé TDI¹
                ...
                the A-wing dynamically accentuate the wide rear of the Audi S5 Coupé TDI¹.</p>
