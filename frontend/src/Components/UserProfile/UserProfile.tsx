...
const UserProfile = () => {
    ...
    return (
        <div className="flex">
            ...
            <div
                className=" break-all relative top-[35px] ml-[30px] bg-gray shadow-md rounded px-8 pt-6 pb-8 mb-4 text-[30px] w-[950px] flex flex-col justify-center items-center">
